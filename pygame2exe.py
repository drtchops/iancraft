...
# all the data directories. All Libraries will be bundled in executable file.
#
...
# This hack make sure that pygame default font is copied:
# no need to modify code for specifying default font
...
class BuildExe:
    def __init__(self):
        ...
        # Name of program
        self.project_name = 'IanCraft'

        # Project url
        self.project_url = 'http://elvenrealms.net:8080/psts'

        # Version of program
        self.project_version = '0.12'

        # License of the program
        self.license = 'IanCraft License'

        # Auhor of program
        self.author_name = 'Ian Robinson'
        self.author_email = 'ian_robinson@rogers.com'
        self.copyright = 'Copyright (c) 2012 Ian Robinson.'

        # Description
        self.project_description = 'The greatest RTS known to man.'

        # Icon file (None will use pygame default icon)
        self.icon_file = 'graphics/iancraft.ico'

        # Extra files/dirs copied to game
        self.extra_datas = ['graphics', 'sound', 'scenarios', 'default.ini',
            'readme.txt', 'changelog.txt']

        # Extra/excludes python modules
        self.extra_modules = ['iancraft']
        self.exclude_modules = ['Tkinter', 'email', 'multiprocessing',
            'xml', 'ctypes', 'compiler', 'curses', 'distutils', 'pydoc',
            'isapi', 'py2exe']
        # apparently I need: unittest
    ...
    def run(self):
        ...
        if self.icon_file == None:
            path = os.path.dirname(pygame.__file__)
